...
var product = "Htc.Vita.External.VC10.Redist";
var companyName = "HTC";
var version = "10.0.40219";
var semanticVersion = string.Format("{0}.{1}", version, revision);
var ciVersion = string.Format("{0}.{1}", version, "0");
var nugetTags = new [] {"htc", "vita", "external", "vc10", "redist"};
var projectUrl = "https://github.com/ViveportSoftware/vita_external_vc10_redist/";
var description = "HTC Vita external package: VC10 redistributable";
...
// Define path
var targetFileNameX64 = string.Format("vcredist_2010_x64-{0}.exe", version);
var targetFileNameX86 = string.Format("vcredist_2010_x86-{0}.exe", version);
var targetFileUrlX64 = "https://download.microsoft.com/download/1/6/5/165255E7-1014-4D0A-B094-B6A430A6BFFC/vcredist_x64.exe";
var targetFileUrlX86 = "https://download.microsoft.com/download/1/6/5/165255E7-1014-4D0A-B094-B6A430A6BFFC/vcredist_x86.exe";
